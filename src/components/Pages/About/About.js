        ...
        <section className="wow fadeIn">
            <div className="container about">
                ...
                <div className="about_content" data-aos="fade-up">
                    <p>
                        Введение. В современном мире проблема протезирования широко изучается и имеет неоспоримую актуальность.
                    ...
                    <p>
                        Основная часть. Разработка бионического протеза состоит из нескольких этапов. Ниже
                        будут рассмотрены основные этапы более подробно.
                    </p>

                    <p>
                        Описание механической части стенда. Кисть любого человека является манипулятором,
                    ...
                    <p>
                        Описание электронной части стенда. Для реализации алгоритмов управления манипулятором предполагается использование
                    ...
                    <p>
                        Заключение. В данной статье был представлен алгоритма распознавания ЭМГ сигнала с использованием ИНС.
